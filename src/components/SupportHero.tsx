...
export function SupportHero({
  ...
  const stats = [
    { icon: Clock, label: "P1 response", value: "15 min" },
    { icon: Activity, label: "Service uptime", value: "99.98%" },
    { icon: Headphones, label: "First touch", value: "Senior" },
    { icon: Users, label: "Engineers", value: "15+" },
  ];
  return (
    <section className="relative isolate overflow-hidden bg-[#050a18] text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-24">
        ...
        <motion.span
          ...
          className="mt-8 inline-flex items-center gap-2 rounded-full border border-emerald-400/40 bg-emerald-500/10 px-4 py-1.5 text-[11px] font-bold uppercase tracking-[0.28em] text-emerald-300"
        >
          <span className="relative flex h-1.5 w-1.5">
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-400 opacity-70" />
            <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-emerald-400" />
          </span>
          Support online · all systems operational
        </motion.span>
        ...
        >
          <span className="bg-gradient-to-r from-white via-white to-accent-200 bg-clip-text text-transparent">
            Senior engineers on first response.
          </span>{" "}
          <span className="text-white/65">Always.</span>
        </motion.h1>
        ...
        >
          We don&apos;t L1-gate tickets. Whichever channel you use, the first
          person who looks at your issue is qualified to actually fix it.
        </motion.p>
          ...
          {stats.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="font-display mt-2 text-2xl text-white md:text-3xl">
                  {s.value}
                </div>
              </div>
            );
...
function BackdropCurves() {
  return (
    ...
    >
      <defs>
        <linearGradient id="sup-curve-a" x1="0" y1="0" x2="1" y2="0">
        ...
        <linearGradient id="sup-curve-b" x1="0" y1="0" x2="1" y2="0">
