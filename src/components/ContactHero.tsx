...
export function ContactHero({
  ...
  const stats = [
    { icon: Clock, label: "Response", value: "Same business day" },
    { icon: PhoneCall, label: "Direct line", value: "+91 99044 08606" },
    { icon: Sparkles, label: "Discovery call", value: "30 min · free" },
    { icon: Calendar, label: "Hours", value: "Mon–Sat · 10–6" },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-24">
        ...
        >
          ...
          <span className="text-white/65">
            We&apos;ll come back with a written view.
          </span>
        </motion.h1>
        ...
        >
          A 30-minute scoping conversation typically saves three months of
          misalignment. Drop a note below or use whichever channel you
          prefer — no slides, no soft-sell.
        </motion.p>
          ...
          {stats.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="font-display mt-2 text-base text-white md:text-lg">
                  {s.value}
                </div>
              </div>
            );
...
function BackdropCurves() {
  return (
    ...
    >
      <defs>
        <linearGradient id="con-curve-a" x1="0" y1="0" x2="1" y2="0">
        ...
        <linearGradient id="con-curve-b" x1="0" y1="0" x2="1" y2="0">
