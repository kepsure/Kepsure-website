...
import { ChevronRight, Calendar, Award, Users, Globe2 } from "lucide-react";
...
export function AboutHero({
  ...
  const stats = [
    ...
    { icon: Award, label: "Certifications", value: "OEM-bound" },
    { icon: Globe2, label: "HQ", value: "Ahmedabad" },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-24">
        ...
        >
          ...
          <span className="text-white/65">
            For the businesses they used to work in.
          </span>
        </motion.h1>
        ...
        >
          Kepsure Solutions Pvt. Ltd. was founded by senior IT operators
          who&apos;d run platforms inside banks, factories and BPOs. The
          promise was simple — apply that internal-team rigour as a service.
        </motion.p>
...
function BackdropCurves() {
  return (
    ...
    >
      <defs>
        <linearGradient id="abt-curve-a" x1="0" y1="0" x2="1" y2="0">
        ...
        <linearGradient id="abt-curve-b" x1="0" y1="0" x2="1" y2="0">
